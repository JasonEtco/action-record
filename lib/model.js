            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        ...
                        return [2 /*return*/, new instance_1.default(found)];
                }
            });
        });
    };
                ...
                switch (_a.label) {
                    ...
                    case 1:
                        ...
                        if (where) {
                            ...
                            return [2 /*return*/, found.map(function (item) { return new instance_1.default(item); })];
                        }
                        else {
                            return [2 /*return*/, issues.map(function (item) { return new instance_1.default(item); })];
                        }
                        return [2 /*return*/];
                }
            });
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        ...
                        return [4 /*yield*/, octokit_1.default.issues.create(__assign({}, github_1.default.context.repo, { title: "[" + this.name + "]: " + id, body: JSON.stringify(opts, null, 2), labels: [this.name] }))
                            // Return the new instance
                        ];
                    case 2:
                        newIssue = _a.sent();
                        // Return the new instance
                        return [2 /*return*/, new instance_1.default(__assign({ action_record_id: id, created_at: newIssue.data.created_at, issue_number: newIssue.data.number }, opts))];
                }
            });
        });
    };
