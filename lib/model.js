            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        ...
                        if (found)
                            return [2 /*return*/, new instance_1.default(this, this.convertIssueToJson(found))];
                ...
                switch (_a.label) {
                    ...
                    case 1:
                        ...
                        if (where) {
                            ...
                            return [2 /*return*/, found.map(function (item) { return new instance_1.default(_this, _this.convertIssueToJson(item)); })];
                        }
                        else {
                            return [2 /*return*/, issues.map(function (item) { return new instance_1.default(_this, _this.convertIssueToJson(item)); })];
                        }
                        return [2 /*return*/];
                }
            });
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        ...
                        return [4 /*yield*/, octokit_1.default.issues.create(__assign({}, github_1.context.repo, { title: "[" + this.name + "]: " + id, body: Model.jsonToBody(data), labels: [this.name] }))
                            // Return the new instance
                        ];
                    case 2:
                        newIssue = _a.sent();
                        // Return the new instance
                        return [2 /*return*/, new instance_1.default(this, __assign({}, data, { created_at: newIssue.data.created_at, issue_number: newIssue.data.number }))];
                }
            });
        });
    };
    Model.jsonToBody = function (data) {
