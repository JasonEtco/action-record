    ...
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    _a.trys.push([0, 2, , 3]);
                    return [4 /*yield*/, octokit_1.default.issues.createLabel(__assign({}, github_1.default.context.repo, { name: name, color: color_hash_1.default.hex(name) }))];
                case 1:
                    _a.sent();
                    return [3 /*break*/, 3];
                case 2:
...
function registerModels(actionRecord) {
    return __awaiter(this, void 0, void 0, function () {
        var baseDir, modelsDir, modelFiles;
        var _this = this;
        return __generator(this, function (_a) {
            baseDir = core_1.default.getInput('baseDir');
            modelsDir = path_1.default.join(baseDir, 'models');
            ...
            return [2 /*return*/, Promise.all(modelFiles.map(function (modelFile) { return __awaiter(_this, void 0, void 0, function () {
                    ...
                    return __generator(this, function (_a) {
                        switch (_a.label) {
                            case 0:
                                modelFn = require(path_1.default.join(modelsDir, modelFile));
